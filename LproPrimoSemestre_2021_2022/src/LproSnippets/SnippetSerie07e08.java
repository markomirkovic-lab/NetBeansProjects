...
public class SnippetSerie07e08
{
    public static void main(String[] args)
    {
        ...
        //Se invece di esprimere l'arrotondamento in perti dell'intero volete usare la cifra, dovete utilizzare questo sistema
        ...
        //ATTENZIONE, gli operatori unari influisocno sul valore delle variabili sulla destra!
        ...
        // 3 - a * ++a + a;
        // 3 - 3 * ++a + a;
        // 3 - 3 *   4 + a;     a=4   Tutte le prossime a (destra) partono dal valore 4
        // 3 - 3 *   4 + 4;     a=4   
        // 3 -  12     + 4;     
        // -9          + 4;     
        //            -5
        ...
        b= a - ++a * a + a;
        // 3 - ++a * a + a;
        // 3 -   4 * a + a;     a=4   Tutte le prossime a (destra) partono dal valore 4
        // 3 -   4 * 4 + a;     
        // 3 -   4 * 4 + 4; 
        // 3 -    16   + 4;                         
        // -13         + 4;                         
        ...
        a= 3;        
        b= ++a - a * ++a + a;
        //   4 - a * ++a + a;   a=4   Tutte le prossime a (destra) partono dal valore 4  
        //   4 - 4 * ++a + a;   a=4
        //   4 - 4 *   5 + a;   a=5   Tutte le prossime a (destra) partono dal valore 5  
        //   4 - 4 *   5 + 5;   a=5
        //   4 -  20     + 5;   
        //   -16         + 5;   
        //             -11
        ...
        c= 10;
        int d= ++a + b + ++c +  (a * b + c);
        //       2 + b + ++c +  (a * b + c);     a=2        Tutte le prossime a (destra) partono dal valore 2  
        //       2 + b + ++c +  (2 * b + c);     a=2 
        //       2 + 5 + ++c +  (2 * 5 + c);     a=2 
        //       2 + 5 +  11 +  (2 * 5 + c);     a=2 c=11   Tutte le prossime c (destra) partono dal valore 11
