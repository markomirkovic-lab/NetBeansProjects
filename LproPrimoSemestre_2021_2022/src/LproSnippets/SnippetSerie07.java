...
public class SnippetSerie07
{
    ...
    {
        Scanner in= new Scanner(System.in);                         //Dichiaro e iniziaizza una variabile Scanner, che si aggancia alla tastiera (rappresentata da System.in)
        ...
        //Dopo una nextLine NON è necessario eseguire una nextLne() a vuoto.
        
        
        //Quando si leggo Stirng e char è SEMPRE consigliabile effettuare un trim(), per togliere eventuali spazi inseriti per errore dall'utente prima e dopo i dati che vorrete leggere!
