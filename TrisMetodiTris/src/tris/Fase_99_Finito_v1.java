...
public class Fase_99_Finito_v1 
{
    public static void main(String[] args) 
    {
        ...
        do
        {
            ...
            {
                celleUguali=0;
                for(c=0; c<tris[r].length; c++)                         //Scorro le altre celle
                {
                    if( tris[r][c]== simbolo )                          //Conto quante celle col simbolo dell'attuale giocatore
                    {
                        celleUguali++;                                  //Conto le celle uguali
                    }
                }
            ...
            if(!vittoria)
            {
                ...
                for(int d=0; d<tris.length; d++)
                {
                    if( tris[d][tris.length-1-d]== simbolo )
                    {
                        celleUguali++;
                    }
                }
