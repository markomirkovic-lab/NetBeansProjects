 ...
 * risparmiando così preziosa memoria!
 * 
...
public class Serie05Soluzione_Es4_v2_EventiGestitiConUnOggettoAdapterComune
{
    private static void createAndShowGUI() 
    {
        ...
        //Prepariamo IL gestore degli eventi
        ...
        for(int i=0; i<caption.length; i++)
        {
            ...
            btn[i].addActionListener(al);           //Aggiungo il gestore, identico per ogni pulsante
        }        
