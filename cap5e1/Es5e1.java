...
public class Es5e1 
{
    ...
    private static void createAndShowGUI()
    {
        ...
        JMenu menuDue = new JMenu("Menu due");
        menuBar.add(menuDue);
        ...
        //Aggiunto al menu principale un terzo menu
        JMenu terziario = new JMenu("Menu Terziario");
        principale.add(terziario);
                
        //Aggiunto al menu secondario un sottomenu "Menu Secondario 2"
        JMenu secondario2= new JMenu("Menu Secondario 2");         
        secondario.add(secondario2);
        ...
        frame.setJMenuBar(menuBar);//!!!! importante per set di quanto sopra
        ...
        frame.getContentPane().add(redLabel, null);//!!!! get
        //setOpaque
