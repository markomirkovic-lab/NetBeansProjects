 ...
 * @author gisi
 */
public class Fase_99_Finito_v3Metodo1 
{
    public static void printBoard(char[][] tris)//prototipo del metodo  ,  (carta grigia x il sportello) printBoard(int r, int c)
    {
        for(int r=0; r<tris.length; r++)//body metodo
            {
    ...
    /*
    public static void printBoard(char[][] tris, larghezza)//prototipo del metodo  ,  (carta grigia x il sportello) printBoard(int r, int c)
    {
        for(int r=0; r<tris.length; r++)//body metodo
            {
                for(int c=0; c<tris[r].length; c++)
                {
                    //int larg= 5;
                    System.out.print( String.format("%4d[%-" + larghezza + "c]%s", (r*tris.length+c)+1, tris[r][c], "     ") );
                    //System.out.print( (r*tris.length+c)+1 + "[" + tris[r][c] + "]\t");          //Notare come calcolo le celle: come tutti i numeri in base 10, ma usando la base 3! Aggiungo 1 per non partire da 0
                }
                System.out.println("");
            }
