...
public class JFrameDemo03_GridLayout
{
    public JFrameDemo03_GridLayout()
    {
        createAndShowGUI();
    }     
    ...
    private void createAndShowGUI() 
    {
        ...
        frame.getContentPane().setLayout(new GridLayout(0, 4, 5, 10));
        frame.getContentPane().add(label);//1 colonna
